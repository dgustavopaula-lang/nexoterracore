...
<header class="ntc-header">
    <div class="ntc-container ntc-header-inner">
        ...
        <nav class="ntc-nav-desktop">
            ...
            <a href="#blog" class="ntc-nav-link">Blog</a>
...
<div class="ntc-drawer" id="ntcDrawer">
    <div class="ntc-drawer-content">
        ...
        <nav class="ntc-drawer-nav">
            ...
            <a href="#blog" class="ntc-drawer-link">Blog</a>
...
<section class="ntc-hero-section">
    <div class="ntc-container">
        ...
        <div class="ntc-hero-content">
            ...
            <span class="ntc-badge">Plataforma • Multi-tenant • Control Plane</span>

            <h1 class="ntc-hero-title">
                NexoTerraCore — dados, território e gestão conectados em uma única plataforma.
            </h1>

            <p class="ntc-hero-subtitle">
                Conecte patrimônio, imóveis, agronegócio, mapas, clientes e operações
                sobre uma infraestrutura central segura e preparada para múltiplas empresas.
            </p>
...
<section class="ntc-section ntc-bg-darker" id="blog">
    <div class="ntc-container">

        <div class="ntc-section-header">
            <span class="ntc-badge">Conhecimento & Mercado</span>
            <h2 class="ntc-section-title">Blog NexoTerraCore</h2>
            <p class="ntc-section-desc">
                Conteúdo sobre tecnologia aplicada ao mundo real, arquitetura de dados,
                agronegócio, patrimônio, território e transformação digital.
            </p>
        </div>
        ...
        <div class="ntc-grid-3">
            ...
            <div class="ntc-card-project">
                <span class="ntc-project-tag">Tecnologia</span>
                <h3>API, Multitenancy & Arquitetura</h3>
                <p>
                    Como sistemas modernos conectam empresas, dados e aplicações
                    com isolamento, segurança e controle.
                </p>
            </div>
            ...
            <div class="ntc-card-project">
                ...
                <h3>Agro & Dados</h3>
                <p>
                    Tecnologia, gestão rural, propriedades, produção e oportunidades
                    para o agronegócio conectado.
                </p>
            </div>

            <div class="ntc-card-project">
                <span class="ntc-project-tag">Território</span>
                <h3>Imóveis, Patrimônio & Mapas</h3>
                <p>
                    Dados geoespaciais, ativos, imóveis, patrimônio e novas formas
                    de organizar informações territoriais.
                </p>
            </div>
        ...
        <div class="ntc-hero-cta" style="margin-top:32px;">
            <a href="https://gustavopaulasantos.com.br/blog/" class="ntc-btn ntc-btn-primary">
                Explorar o Blog
            </a>
        </div>
